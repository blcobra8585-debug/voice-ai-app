      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(120).duration(400)}>
          <Section title="🎚️ Audio Controls">
            <SliderRow
              label="Pitch Offset" sub="Shift pitch for all effects"
            ...
            <SliderRow
              label="Volume Boost" sub="Amplify output volume"
            ...
            <View style={[styles.divider, { backgroundColor: colors.glassBorder }]} />
            <SliderRow
              label="Auto-Stop Timer" sub="Auto-stop recording after N seconds (0 = disabled)"
        ...
        <Animated.View entering={FadeInDown.delay(180).duration(400)}>
          <Section title="⚡ Modes">
            <Row label="BGMI Mode" sub="Audio plays in background (game/call)">
