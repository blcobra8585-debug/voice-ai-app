    ...
    <GlassCard style={[styles.clipCard, isPlaying && { borderColor: color }]}>
      <View style={styles.clipMain}>
        ...
        <View style={styles.clipActions}>
          ...
          <ActionBtn icon="star" color={clip.isFavorite ? "#FFD700" : colors.mutedForeground}
            ...
            <GlassCard style={styles.audioIndicator}>
              {pitchOffset !== 0 && (
                <View style={styles.audioChip}>
                  ...
                  <Text style={[styles.audioChipText, { color: colors.cyan }]}>Pitch {pitchOffset > 0 ? "+" : ""}{pitchOffset}</Text>
                </View>
              )}
              {volumeBoost !== 1.0 && (
                <View style={styles.audioChip}>
        ...
        {isIdle && clips.length === 0 && (
          <Animated.View entering={FadeIn.delay(300).duration(500)} style={styles.empty}>
            ...
            <View style={styles.emptyFeatures}>
              {["6 AI Voices (ElevenLabs)", "14 Local Effects", "Live Real-time Mode", "WhatsApp · Telegram · BGMI"].map(f => (
